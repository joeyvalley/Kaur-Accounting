      ...
      <div className="content-border2">
        <div className="content">
          <div className="contact">
            ...
            <p>
              If you have any questions on our services please don't hesitate to reach out to us directly at <a href="mailto:info@kauraccounting.com">info@kauraccounting.com</a>.
            </p>
            <h2>Employment:</h2>
            <p>We are always looking to expand our team! Any questions about employment opportunities can be sent to <a href="mailto:careers@kauraccounting.com">careers@kauraccounting.com</a></p>
            <h2>Our Team:</h2>
            <div className="staff">
